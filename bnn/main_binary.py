...
parser.add_argument('--momentum', default=0.9, type=float, metavar='M',
                    help='momentum')
parser.add_argument('--weight-decay', '--wd', default=0, type=float,        # Set to zero
...
def main():
    ...
    val_data = get_dataset(args.dataset, args.data_path, 'val', transform['eval'])
    ...
    train_data = get_dataset(args.dataset, args.data_path, 'train', transform['train'])
